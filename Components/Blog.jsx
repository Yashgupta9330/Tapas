            ...
            <div className="row">
                <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div className="post-box">
                        ...
                        <h3 className="post-title">Eum ad dolor et. Autem aut fugiat debitis voluptatem consequuntur sit
                        </h3>
                        ...
                        <Link  href="blog-details.html" className="readmore stretched-link"><span>Read More</span><i
                ...
                <div className="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div className="post-box">
                        <div className="post-img"><img src="/assets/img/blog/blog-2.jpg" className="img-fluid" alt="" />
                        </div>
                        <div className="meta">
                ...
                <div className="col-lg-4" data-aos="fade-up" data-aos-delay="600">
                    <div className="post-box">
                        <div className="post-img"><img src="/assets/img/blog/blog-3.jpg" className="img-fluid" alt="" />
                        </div>
                        <div className="meta">
